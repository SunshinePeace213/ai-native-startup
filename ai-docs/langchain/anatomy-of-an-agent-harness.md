...
fetched: 2026-08-05
---
> **In here:** Agent = Model + Harness definition · harness components (filesystem, bash/code exec, sandboxes, memory/search, context management) · long-horizon execution and future of harness/model co-evolution
...
The rest of this post walks through core harness components and derives _why_ each piece exists working backwards from the core primitive of a model.
