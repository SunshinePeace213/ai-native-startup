...
fetched: 2026-07-28
---
> **In here:** the agentic loop and built-in verification (`/verify`, Code Review, GitHub Actions, spec validation, rubrics) · writing verification checks in plain English as skills · deployment patterns — standalone, embedded, chained, on every PR
