...
fetched: 2026-07-21
---
> **In here:** Identifying unknowns · Pre-implementation patterns · Implementation & review patterns
...
- **Known knowns**: Information explicitly stated in your prompt
- **Known unknowns**: Gaps you're aware of but haven't resolved
- **Unknown knowns**: Obvious contextual details you wouldn't write down
- **Unknown unknowns**: Information you're not aware is missing
...
Reducing and planning for your unknowns is the skill of agentic coding. But luckily, this is a skill you can improve at, by working with Claude.
