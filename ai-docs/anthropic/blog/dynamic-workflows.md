...
fetched: 2026-08-05
---
> **In here:** dynamic workflows JS harness patterns · why (agentic laziness, self-preferential bias, goal drift) · use cases and tips (prompting, /goal, /loop, budgets, sharing)
...
Category: Claude Code · Date: June 2, 2026 · Reading time: 5 min
...
If you have a particular set of rules that you find Claude misses or struggles with, even when put into the `CLAUDE.md`s, create a workflow with a list of rules that must be checked by verifier agents—one verifier per rule. Creating a skeptic persona subagent to review the rules to make sure they are in line will help avoid too many false positives.
