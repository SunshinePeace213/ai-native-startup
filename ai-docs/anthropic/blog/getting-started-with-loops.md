...
fetched: 2026-07-28
---
> **In here:** turn-based, goal-based, time-based, and proactive loop types · maintaining code quality and managing token usage in loops · getting started checklist and loop comparison table
...
This should include tools or connectors to allow Claude to _see_, _measure_ or _interact_ with the result. The more quantitative the checks are, the easier it is for Claude to self-verify.
