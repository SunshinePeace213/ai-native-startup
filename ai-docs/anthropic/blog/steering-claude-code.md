...
fetched: 2026-07-28
---
> **In here:** seven ways to instruct Claude Code (CLAUDE.md, rules, skills, subagents, hooks, output styles, system-prompt append) · comparison table of load timing, compaction behavior, context cost · anti-patterns and when to reach for each method
