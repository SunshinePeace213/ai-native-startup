...
fetched: 2026-07-28
---
> **In here:** model aliases (opus/sonnet/haiku/fable/opusplan) · configuring models via CLI, settings.json, env vars · provider-specific model resolution and effort levels
