...
fetched: 2026-08-07
---
> **In here:** hybrid Slack retrieval (full-text + embeddings + IDF + age decay) · code/repo embedding pipeline with CocoIndex · planner/executor/reranker architecture (RRF, MCP tools, projects)
