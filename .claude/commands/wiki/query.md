...
- If no page in INDEX bears on QUESTION, say plainly that the wiki doesn't cover it. Never guess, and never fall back to the raw `ai-docs/` sources to fill the gap.
