...
- **Subagents**: plan's `claude-code-guide` and `kb-fetcher` helpers, the plan
  and build `opus` page authors, `/kb` fan-out, the tidy simplifiers, and
  review's Codex runner and fixers.
